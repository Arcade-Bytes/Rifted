    ...
    : Entity(maxHealth)
{
    ...
    this->sword = new Weapon(0.3f, 0.1f, 0.2f, 55, 60, 30, true, {500.0f, 400.0f}, LIGHT_ATTACK);
    this->hammer = new Weapon(1.5f, 0.7f, 0.4f, 120, 70, 60, true, {1000.0f, 500.0f}, HEAVY_ATTACK);
